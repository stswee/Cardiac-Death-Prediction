...
if __name__ == "__main__":
    ...
    df = pd.read_csv("../Data/subject-info-cleaned-with-prompts-repeated.csv") # Plan A requires repeats
    ...
    df.to_csv("../Data/subject-info-cleaned-with-prognosis-A.csv") # Plan A